defmodule Mccap.BankProvider.AdaptersTest do
  ...
  describe "ES Adapter" do
    test "returns deterministic credit_score and annual_income_verified" do
      ...
      {:ok, result1} = Mccap.BankProvider.ES.fetch_client_data(doc)
      {:ok, result2} = Mccap.BankProvider.ES.fetch_client_data(doc)
  ...
  describe "PT Adapter" do
    test "returns deterministic risk_class and debt_ratio" do
      ...
      {:ok, result1} = Mccap.BankProvider.PT.fetch_client_data(doc)
      {:ok, result2} = Mccap.BankProvider.PT.fetch_client_data(doc)
  ...
  describe "IT Adapter" do
    test "returns deterministic financial_stability and employer_verified" do
      ...
      {:ok, result1} = Mccap.BankProvider.IT.fetch_client_data(doc)
      {:ok, result2} = Mccap.BankProvider.IT.fetch_client_data(doc)
  ...
  describe "MX Adapter" do
    test "returns deterministic buro_score and active_credits" do
      ...
      {:ok, result1} = Mccap.BankProvider.MX.fetch_client_data(doc)
      {:ok, result2} = Mccap.BankProvider.MX.fetch_client_data(doc)
  ...
  describe "CO Adapter" do
    test "returns deterministic debt properties based on income" do
      ...
      {:ok, result1} = Mccap.BankProvider.CO.fetch_client_data(doc)
      {:ok, result2} = Mccap.BankProvider.CO.fetch_client_data(doc)
  ...
  describe "BR Adapter" do
    test "returns deterministic serasa_score, cpf_status, and open_credits" do
      ...
      {:ok, result1} = Mccap.BankProvider.BR.fetch_client_data(doc)
      {:ok, result2} = Mccap.BankProvider.BR.fetch_client_data(doc)
