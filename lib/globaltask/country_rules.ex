defmodule Globaltask.CountryRules do
  @moduledoc """
  Behaviour and dispatcher for country-specific validation rules.

  Each country module (e.g. `Globaltask.CountryRules.ES`) implements three
  ...
  Country modules should `use Globaltask.CountryRules` to get the behaviour
  annotation and a default no-op `on_status_change/2` that can be overridden:

      defmodule Globaltask.CountryRules.XX do
  ...
  @country_modules %{
    "ES" => Globaltask.CountryRules.ES,
    "PT" => Globaltask.CountryRules.PT,
    "IT" => Globaltask.CountryRules.IT,
    "MX" => Globaltask.CountryRules.MX,
    "CO" => Globaltask.CountryRules.CO,
    "BR" => Globaltask.CountryRules.BR
  }
  ...
  ## Examples
      ...
      iex> Globaltask.CountryRules.resolve("ES")
      {:ok, Globaltask.CountryRules.ES}

      iex> Globaltask.CountryRules.resolve("XX")
