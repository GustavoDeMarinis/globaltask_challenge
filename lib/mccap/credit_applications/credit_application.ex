defmodule Mccap.CreditApplications.CreditApplication do
  @moduledoc """
  ...
  schema "credit_applications" do
    ...
    has_many :audit_logs, Mccap.CreditApplications.AuditLog
  ...
  via `Mccap.CountryRules.validate/1` after basic field checks.
